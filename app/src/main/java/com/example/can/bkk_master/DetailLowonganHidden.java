...
public class DetailLowonganHidden extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lihat_industri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DetailLowonganHidden.this, DetailIndustri.class);
    ...
    public void ambilData()
    {
        ...
        pDialog = new ProgressDialog(DetailLowonganHidden.this);
                        ...
                        try {
                            ...
                            for (int i =0; i<dataArray.length(); i++)
                            {
                                ...
                                if (extraId== id )
                                {
                                    ...
                                    Picasso.with(DetailLowonganHidden.this)
